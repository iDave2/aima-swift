...
//   */
//  func getAgents() -> Set<Agent>
//
//  /**
//   * - Returns: The EnvironmentObjects that exist in this Environment.
//   */
//  func getEnvironmentObjects() -> Set<EnvironmentObject>
//
//  /**
...
//   */
//  func addEnvironmentObject(_ object: EnvironmentObject, at location: Location?) -> Void
//
//  /**
//   * Remove an EnvironmentObject from the Environment.
//   *
//   * - Parameter object: The thing to be removed.
//   */
//  func removeEnvironmentObject(_ object: EnvironmentObject) -> Void
//
//  /**
...
//
//  /**
//   * Move the Environment forward by a given number of time steps.
//   *
//   * - Parameter repeat: The number of time steps to move the Environment forward.
//   */
//  func step(_ repeat: Int) -> Void
//
//  /**
//   * Step through time steps until the Environment has no more tasks.
//   */
//  func stepUntilDone() -> Void
//
//  /**
...
//   *
//   * - Parameter forAgent: The Agent for which a performance measure is to be retrieved.
//   * - Returns: The performance measure associated with the Agent.
//   */
//  func getPerformanceMeasure(forAgent agent: Agent) -> Double?
//
//  /**
//   * Add a view on the Environment.
//   *
//   * - Parameter view: The EnvironmentView to be added.
//   */
//  func addEnvironmentView(_ view: EnvironmentView) -> Void
//
//  /**
//   * Remove a view on the Environment.
//   *
//   * - Parameter view: The EnvironmentView to be removed.
//   */
//  func removeEnvironmentView(_ view: EnvironmentView) -> Void
//
//  /**
//   * Notify all registered EnvironmentViews of a message.
//   *
//   * - Parameter message: The message to notify the registered EnvironmentViews with.
//   */
//  func notifyViews(_ message: String) -> Void
//
//}
